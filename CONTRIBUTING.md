...
In the spirit of Open Source Software, everyone is very welcome to contribute to this repository. Feel free to [raise issues](https://github.com/willfarrell/aws-events/issues) or to [submit Pull Requests](https://github.com/willfarrell/aws-events/pulls).

## Development Setup

```bash
git clone https://github.com/willfarrell/aws-events.git
cd aws-events
npm install
npm test
```
